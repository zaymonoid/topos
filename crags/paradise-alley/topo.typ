  ...
  #align(center)[
    #box(width: 6.5in)[
      #align(left)[
        ...
        #let max-count = 6
        #let chart-h = 80pt
        // Bars + numbers (aligned to a common baseline)
        #grid(
          columns: counts.len() * (1fr,),
          column-gutter: 5pt,
          align: bottom + center,
          ..counts.map(((g, n)) => align(bottom + center, stack(
            dir: ttb,
            spacing: 3pt,
            text(font: mono-font, size: 7.5pt, fill: stone, weight: 700, str(n)),
            rect(
              width: 75%,
              height: chart-h * n / max-count,
              fill: grade-color(g),
              radius: (top: 3pt),
              stroke: none,
            ),
        ...
        #v(3pt)
        // Grade labels below baseline
        #grid(
          columns: counts.len() * (1fr,),
          column-gutter: 5pt,
          align: top + center,
          ..counts.map(((g, _)) => text(font: mono-font, size: 7.5pt, fill: muted, g))
        )
      ]
    ]
  ]
...
#grid(
  ...
  align(center)[
    #image("images/overview.jpg", height: 2.6in)
    #v(2pt)
...
#grid(
  ...
  column-gutter: 16pt,
  align: top,
  image("images/walls/wall1.jpg", height: 3.2in),
  [
...
#grid(
  ...
  column-gutter: 16pt,
  align: top,
  image("images/walls/wall2.jpg", height: 2.8in),
  [
...
#grid(
  ...
  column-gutter: 16pt,
  align: top,
  image("images/walls/wall3.jpg", width: 100%),
  [
...
#grid(
  ...
  column-gutter: 16pt,
  align: top,
  image("images/walls/wall4.jpg", height: 2.4in),
  [
...
#align(center, image("images/walls/wall6.jpg", height: 4in))
...
#align(center, image("images/walls/wall7.jpg", height: 3.8in))
